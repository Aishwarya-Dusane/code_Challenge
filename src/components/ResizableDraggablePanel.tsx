...
const ResizableDraggablePanel: React.FC<Props> = ({
  id, title, content, x, y, width, height, minWidth, minHeight, onClose, onMove, onResize, zIndex, onFocus
}) => {
  ...
  return (
    <div
      style={{
        ...
        overflow: 'hidden',
        zIndex, // Use dynamic zIndex from props
        display: 'flex',
        ...
        maxHeight: '100%',
         ...
         onMouseDown={onFocus} // Add this line
    >
      <div
        style={{
          cursor: 'move',
